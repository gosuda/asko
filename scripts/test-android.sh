...
"$asko_repo/scripts/dev" env -u C_INCLUDE_PATH -u CPATH -u LIBRARY_PATH -u PKG_CONFIG_PATH \
    ...
    _build/default.android/test/test_telemetry.exe _build/default.android/test/test_go.exe
...
scp -q dist/asko dist/cacert.pem _build/default.android/test/test_core.exe \
    ...
    _build/default.android/test/test_web_fetch.exe _build/default.android/test/test_telemetry.exe _build/default.android/test/test_go.exe "$asko_target:asko-runtime-test/"
...
chmod 700 asko test_core.exe test_store.exe test_http.exe test_summary.exe test_pipeline.exe test_context.exe test_diagnostics.exe test_web_fetch.exe test_telemetry.exe test_go.exe
./asko version
./test_core.exe
./test_store.exe
./test_http.exe
