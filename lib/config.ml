...
let default = {
  ...
  dry_run=true; retention_days=7; recovery_interval=30.; reconcile_interval=1800.; request_ttl=1800.;
  cooldown=0.; http_timeout=600.; send_interval=1.; confirm_timeout=15.;
